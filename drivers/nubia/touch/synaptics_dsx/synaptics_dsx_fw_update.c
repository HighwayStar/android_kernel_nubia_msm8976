...
#define FW_IMAGE_NAME "nubia_tp_jdi_fw.img"
#define FW_IMAGE_NAME_W "startup_fw_update_w.img"
...
static enum flash_area fwu_go_nogo(void)
{
	...
	//NX563 add for force update temprary, will be changed soon...
	if (fwu->force_update || 1) {
...
static int fwu_start_reflash(void)
{
	...
	if (fwu->image == NULL) {
		if(!strncmp(rmi->product_id_string, "NUBIA-JDI", 10)) {
