...
/* enable synaptics resume workqueue */
//#define NUBIA_SYNAPTICS_RESUME_WORK_QUEUE

/* enable synaptics enable wakeup gesture after firmware spontaneous reset workqueue */
#define NUBIA_ENABLE_WAKEUP_GESTURE_FLAG
...
//nubia for pinctrl
	...
	struct work_struct synaptics_resume_work;
	struct workqueue_struct *synaptics_resume_wq;
#endif
	...
	void (*sleep_enable)(struct synaptics_rmi4_data *rmi4_data,
			bool enable);
#ifdef NUBIA_SYNAPTICS_IC_DETECT_RESET_CHECK
	int (*reinit_device)(struct synaptics_rmi4_data *rmi4_data);
#endif
};
