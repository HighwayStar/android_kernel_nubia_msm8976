...
#define INPUT_PHYS_NAME "btn_synaptics/touch_input"
#define STYLUS_PHYS_NAME "btn_synaptics_/stylus"
...
//nubia for pinctrl
#ifdef NUBIA_BTN_SYNAPTICS_PINCTRL
#define BTN_SYNAPTICS_PINCTRL_STATE_SUSPEND "touch_button_pin_suspend"
#define BTN_SYNAPTICS_PINCTRL_STATE_ACTIVE "touch_button_pin_active"
#endif

#ifdef NUBIA_BTN_SYNAPTICS_PALM_SUPPORT_FLAG
#define BTN_SYNAPTICS_PALM_ADDR 0X0400
#define BTN_SYNAPTICS_PALM_F12_ADDR 0x0418
...
#define BTN_SYNAPTICS_VDD_MIN_UV	3300000
#define BTN_SYNAPTICS_VDD_MAX_UV	3300000
#define BTN_SYNAPTICS_VIO_MIN_UV	1750000
#define BTN_SYNAPTICS_VIO_MAX_UV	1950000
...
static int btn_synaptics_rmi4_check_status(struct btn_synaptics_rmi4_data *rmi4_data,
		bool *was_in_bl_mode);
static int btn_synaptics_rmi4_free_fingers(struct btn_synaptics_rmi4_data *rmi4_data);
static int btn_synaptics_rmi4_reinit_device(struct btn_synaptics_rmi4_data *rmi4_data);
static int btn_synaptics_rmi4_reset_device(struct btn_synaptics_rmi4_data *rmi4_data,
		bool rebuild);

#ifdef CONFIG_FB
static int btn_synaptics_rmi4_fb_notifier_cb(struct notifier_block *self,
		unsigned long event, void *data);
static void btn_synaptics_rmi4_resume_work(struct work_struct *work);
...
static void btn_synaptics_rmi4_early_suspend(struct early_suspend *h);

static void btn_synaptics_rmi4_late_resume(struct early_suspend *h);
#endif

static int btn_synaptics_rmi4_suspend(struct device *dev);

static int btn_synaptics_rmi4_resume(struct device *dev);

static ssize_t btn_synaptics_rmi4_f01_reset_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t btn_synaptics_rmi4_f01_productinfo_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t btn_synaptics_rmi4_f01_buildid_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t btn_synaptics_rmi4_f01_flashprog_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t btn_synaptics_rmi4_0dbutton_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t btn_synaptics_rmi4_0dbutton_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t btn_synaptics_rmi4_suspend_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t btn_synaptics_rmi4_wake_gesture_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t btn_synaptics_rmi4_wake_gesture_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t btn_synaptics_rmi4_palm_sleep_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t btn_synaptics_rmi4_palm_sleep_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t btn_synaptics_rmi4_virtual_key_map_show(struct kobject *kobj,
...
struct btn_synaptics_rmi4_f01_device_status {
	union {
		struct {
...
struct btn_synaptics_rmi4_f11_query_0_5 {
	union {
		struct {
			/* query 0 */
...
struct btn_synaptics_rmi4_f11_query_7_8 {
	union {
		struct {
			/* query 7 */
...
struct btn_synaptics_rmi4_f11_query_9 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f11_query_12 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f11_query_27 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f11_ctrl_6_9 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f11_data_1_5 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f12_query_5 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f12_query_8 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f12_ctrl_8 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f12_ctrl_23 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f12_ctrl_31 {
	union {
		struct {
			unsigned char max_x_coord_lsb;
			unsigned char max_x_coord_msb;
...
struct btn_synaptics_rmi4_f12_finger_data {
...
struct btn_synaptics_rmi4_f1a_query {
	union {
		struct {
...
struct btn_synaptics_rmi4_f1a_control_0 {
	union {
		struct {
...
struct btn_synaptics_rmi4_f1a_control {
	struct btn_synaptics_rmi4_f1a_control_0 general_control;
...
struct btn_synaptics_rmi4_f1a_handle {
	int button_bitmask_size;
	unsigned char max_count;
	unsigned char valid_button_count;
	unsigned char *button_data_buffer;
	unsigned char *button_map;
	struct btn_synaptics_rmi4_f1a_query button_query;
	struct btn_synaptics_rmi4_f1a_control button_control;
};

struct btn_synaptics_rmi4_exp_fhandler {
	struct btn_synaptics_rmi4_exp_fn *exp_fn;
	bool insert;
	bool remove;
	struct list_head link;
};

struct btn_synaptics_rmi4_exp_fn_data {
	bool initialized;
	bool queue_work;
	struct mutex mutex;
	...
	struct btn_synaptics_rmi4_data *rmi4_data;
};

static struct btn_synaptics_rmi4_exp_fn_data exp_data;

static struct btn_synaptics_button_map *vir_button_map;

#ifdef NUBIA_TP_NODE_IN_KERNEL
	static struct btn_synaptics_rmi4_data *nubia_tp;
#endif
//nubia, new kernel needs more strict permisson
//S_IWUGO->S_IWUSR
static struct device_attribute attrs[] = {
	__ATTR(reset, S_IWUSR,
			btn_synaptics_rmi4_show_error,
			btn_synaptics_rmi4_f01_reset_store),
	__ATTR(productinfo, S_IRUGO,
			btn_synaptics_rmi4_f01_productinfo_show,
			btn_synaptics_rmi4_store_error),
	__ATTR(buildid, S_IRUGO,
			btn_synaptics_rmi4_f01_buildid_show,
			btn_synaptics_rmi4_store_error),
	__ATTR(flashprog, S_IRUGO,
			btn_synaptics_rmi4_f01_flashprog_show,
			btn_synaptics_rmi4_store_error),
	__ATTR(0dbutton, (S_IRUGO | S_IWUSR),
			btn_synaptics_rmi4_0dbutton_show,
			btn_synaptics_rmi4_0dbutton_store),
	__ATTR(suspend, S_IWUSR,
			btn_synaptics_rmi4_show_error,
			btn_synaptics_rmi4_suspend_store),
	__ATTR(wake_gesture, (S_IRUGO | S_IWUSR),
			btn_synaptics_rmi4_wake_gesture_show,
			btn_synaptics_rmi4_wake_gesture_store),
	__ATTR(palm_sleep, (S_IRUGO | S_IWUSR),
			btn_synaptics_rmi4_palm_sleep_show,
			btn_synaptics_rmi4_palm_sleep_store),
};
...
static struct kobj_attribute virtual_key_map_attr = {
	...
	.show = btn_synaptics_rmi4_virtual_key_map_show,
};
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned int reset;
	struct btn_synaptics_rmi4_data *rmi4_data = dev_get_drvdata(dev);
	...
	retval = btn_synaptics_rmi4_reset_device(rmi4_data, false);
	if (retval < 0) {
...
{
	int retval;
	struct btn_synaptics_rmi4_f01_device_status device_status;
	struct btn_synaptics_rmi4_data *rmi4_data = dev_get_drvdata(dev);

	retval = btn_synaptics_rmi4_reg_read(rmi4_data,
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	struct btn_synaptics_rmi4_fn *fhandler;
	struct btn_synaptics_rmi4_data *rmi4_data = dev_get_drvdata(dev);
	struct btn_synaptics_rmi4_device_info *rmi;
	...
	list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
		if (fhandler->fn_number == BTN_SYNAPTICS_RMI4_F1A) {
			...
			retval = btn_synaptics_rmi4_reg_write(rmi4_data,
					rmi4_data->f01_ctrl_base_addr + 1 + ii,
					&intr_enable,
					sizeof(intr_enable));
			if (retval < 0)
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if (input == 1)
		btn_synaptics_rmi4_suspend(dev);
	else if (input == 0)
		btn_synaptics_rmi4_resume(dev);
	else
		return -EINVAL;
...
unsigned int nubia_btn_wakeup_gesture = 0;
static ssize_t btn_synaptics_rmi4_wake_gesture_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count)
{
	unsigned int input;
	...
	if (rmi4_data->f11_wakeup_gesture || rmi4_data->f12_wakeup_gesture) {
		...
		nubia_btn_wakeup_gesture = input;
	}
	return count;
}
...
static ssize_t nubia_wake_gesture_show(struct kobject *kobj,
		struct kobj_attribute *attr, char *buf)
{
	struct btn_synaptics_rmi4_data *rmi4_data = nubia_tp;
...
#ifdef NUBIA_BTN_SYNAPTICS_PALM_SUPPORT_FLAG
static bool isLargeTouch(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
	char detected_palm = 0;
	retval = btn_synaptics_rmi4_reg_read(rmi4_data,BTN_SYNAPTICS_PALM_ADDR,
			&detected_palm,
			sizeof(detected_palm));
	return (detected_palm == 1) ? true : false;
}

static bool btn_synaptics_f12_palm_touch(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
	char detected_palm = 0;
	retval = btn_synaptics_rmi4_reg_read(rmi4_data,BTN_SYNAPTICS_PALM_F12_ADDR,
			&detected_palm,
			sizeof(detected_palm));
	return (detected_palm == 1) ? true : false;
}

static int report_palm_event(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int ret;
	ret = btn_synaptics_f12_palm_touch(rmi4_data);
	if (ret) {
...
static int btn_synaptics_rmi4_f11_abs_report(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler)
{
	int retval;
	...
	int wy;
	int temp;
	struct btn_synaptics_rmi4_f11_data_1_5 data;
	struct btn_synaptics_rmi4_f11_extra_data *extra_data;
	...
	extra_data = (struct btn_synaptics_rmi4_f11_extra_data *)fhandler->extra;
	...
	{
		btn_synaptics_rmi4_free_fingers(rmi4_data);
...
static int btn_synaptics_rmi4_f12_abs_report(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler)
{
	int retval;
	unsigned char touch_count = 0; /* number of touch points */
	...
	int pressure;
#endif
	struct btn_synaptics_rmi4_f12_extra_data *extra_data;
	struct btn_synaptics_rmi4_f12_finger_data *data;
	struct btn_synaptics_rmi4_f12_finger_data *finger_data;
	...
	data_addr = fhandler->full_addr.data_base;
	extra_data = (struct btn_synaptics_rmi4_f12_extra_data *)fhandler->extra;
	size_of_2d_data = sizeof(struct btn_synaptics_rmi4_f12_finger_data);
...
//nubia for palm sleep
	...
	data = (struct btn_synaptics_rmi4_f12_finger_data *)fhandler->data;
...
//nubia for palm sleep
#ifdef NUBIA_BTN_SYNAPTICS_PALM_SUPPORT
				input_report_abs(rmi4_data->input_dev,
						ABS_MT_PRESSURE, wx);
#endif
			} else {
...
static void btn_synaptics_rmi4_f1a_report(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler)
{
	int retval;
	...
	struct btn_synaptics_rmi4_f1a_handle *f1a = fhandler->data;
...
static void btn_synaptics_rmi4_report_touch(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler)
{
	...
	case BTN_SYNAPTICS_RMI4_F11:
		touch_count_2d = btn_synaptics_rmi4_f11_abs_report(rmi4_data,
				fhandler);
		...
		break;
	case BTN_SYNAPTICS_RMI4_F12:
		touch_count_2d = btn_synaptics_rmi4_f12_abs_report(rmi4_data,
				fhandler);
		...
		if (touch_count_2d)
			...
			rmi4_data->fingers_on_2d = false;
		break;
	case BTN_SYNAPTICS_RMI4_F1A:
		btn_synaptics_rmi4_f1a_report(rmi4_data, fhandler);
		break;
	default:
		break;
	}
...
static void btn_synaptics_rmi4_sensor_report(struct btn_synaptics_rmi4_data *rmi4_data,
		bool report)
{
	int retval;
	...
	bool was_in_bl_mode;
	struct btn_synaptics_rmi4_f01_device_status status;
	struct btn_synaptics_rmi4_fn *fhandler;
	struct btn_synaptics_rmi4_exp_fhandler *exp_fhandler;
	struct btn_synaptics_rmi4_device_info *rmi;
	...
	if (status.status_code == STATUS_CRC_IN_PROGRESS) {
		retval = btn_synaptics_rmi4_check_status(rmi4_data,
				&was_in_bl_mode);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
	...
	if (status.unconfigured && !status.flash_prog) {
		...
		retval = btn_synaptics_rmi4_reinit_device(rmi4_data);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
		...
		list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
			if (fhandler->num_of_data_sources) {
				if (fhandler->intr_mask &
					...
					btn_synaptics_rmi4_report_touch(rmi4_data,
							fhandler);
				}
			}
		}
...
static irqreturn_t btn_synaptics_rmi4_irq(int irq, void *data)
{
	struct btn_synaptics_rmi4_data *rmi4_data = data;
	const struct btn_synaptics_board_data *bdata =
			rmi4_data->hw_if->board_data;

	if (gpio_get_value(bdata->irq_gpio) != bdata->irq_on_state)
		goto exit;

	btn_synaptics_rmi4_sensor_report(rmi4_data, true);

exit:
	return IRQ_HANDLED;
}

static int btn_synaptics_rmi4_int_enable(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable)
{
	int retval = 0;
	unsigned char ii;
...
static int btn_synaptics_rmi4_irq_enable(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable, bool attn_only)
{
	...
	if (attn_only) {
		retval = btn_synaptics_rmi4_int_enable(rmi4_data, enable);
		return retval;
	}
	...
	if (enable) {
		...
		retval = btn_synaptics_rmi4_int_enable(rmi4_data, false);
		if (retval < 0)
			return retval;

		/* Process and clear interrupts */
		btn_synaptics_rmi4_sensor_report(rmi4_data, false);

		retval = request_threaded_irq(rmi4_data->irq, NULL,
				btn_synaptics_rmi4_irq, bdata->irq_flags,
		...
		retval = btn_synaptics_rmi4_int_enable(rmi4_data, true);
		if (retval < 0)
			return retval;
...
static void btn_synaptics_rmi4_set_intr_mask(struct btn_synaptics_rmi4_fn *fhandler,
		struct btn_synaptics_rmi4_fn_desc *fd,
...
static int btn_synaptics_rmi4_f01_init(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler,
		struct btn_synaptics_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	btn_synaptics_rmi4_set_intr_mask(fhandler, fd, intr_count);
...
static int btn_synaptics_rmi4_f11_init(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler,
		struct btn_synaptics_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	unsigned char fingers_supported;
	struct btn_synaptics_rmi4_f11_extra_data *extra_data;
	struct btn_synaptics_rmi4_f11_query_0_5 query_0_5;
	struct btn_synaptics_rmi4_f11_query_7_8 query_7_8;
	struct btn_synaptics_rmi4_f11_query_9 query_9;
	struct btn_synaptics_rmi4_f11_query_12 query_12;
	struct btn_synaptics_rmi4_f11_query_27 query_27;
	struct btn_synaptics_rmi4_f11_ctrl_6_9 control_6_9;
	const struct btn_synaptics_board_data *bdata =
				rmi4_data->hw_if->board_data;
...
static int btn_synaptics_rmi4_f12_set_enables(struct btn_synaptics_rmi4_data *rmi4_data,
...
static int btn_synaptics_rmi4_f12_ctrl_sub(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler,
		struct btn_synaptics_rmi4_f12_query_5 *query_5,
...
static int btn_synaptics_rmi4_f12_init(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler,
		struct btn_synaptics_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	struct btn_synaptics_rmi4_f12_extra_data *extra_data;
	struct btn_synaptics_rmi4_f12_query_5 *query_5 = NULL;
	struct btn_synaptics_rmi4_f12_query_8 *query_8 = NULL;
	struct btn_synaptics_rmi4_f12_ctrl_8 *ctrl_8 = NULL;
	struct btn_synaptics_rmi4_f12_ctrl_23 *ctrl_23 = NULL;
	struct btn_synaptics_rmi4_f12_ctrl_31 *ctrl_31 = NULL;
	const struct btn_synaptics_board_data *bdata =
				rmi4_data->hw_if->board_data;
	...
	for (subpacket = 2; subpacket <= 4; subpacket++) {
		retval = btn_synaptics_rmi4_f12_ctrl_sub(rmi4_data,
...
/* nubia, no need stylus */
	...
	retval = btn_synaptics_rmi4_f12_set_enables(rmi4_data,
...
static int btn_synaptics_rmi4_f1a_alloc_mem(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler)
{
	int retval;
	struct btn_synaptics_rmi4_f1a_handle *f1a;
...
static int btn_synaptics_rmi4_f1a_button_map(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler)
{
	int retval;
	unsigned char ii;
...
static void btn_synaptics_rmi4_f1a_kfree(struct btn_synaptics_rmi4_fn *fhandler)
{
	struct btn_synaptics_rmi4_f1a_handle *f1a = fhandler->data;
...
static int btn_synaptics_rmi4_f1a_init(struct btn_synaptics_rmi4_data *rmi4_data,
		struct btn_synaptics_rmi4_fn *fhandler,
		struct btn_synaptics_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	retval = btn_synaptics_rmi4_f1a_alloc_mem(rmi4_data, fhandler);
	if (retval < 0)
		goto error_exit;

	retval = btn_synaptics_rmi4_f1a_button_map(rmi4_data, fhandler);
	if (retval < 0)
		goto error_exit;
...
error_exit:
	btn_synaptics_rmi4_f1a_kfree(fhandler);

	return retval;
}

static void btn_synaptics_rmi4_empty_fn_list(struct btn_synaptics_rmi4_data *rmi4_data)
{
	struct btn_synaptics_rmi4_fn *fhandler;
	struct btn_synaptics_rmi4_fn *fhandler_temp;
	struct btn_synaptics_rmi4_device_info *rmi;
...
static void btn_synaptics_rmi4_set_configured(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
...
static int btn_synaptics_rmi4_alloc_fh(struct btn_synaptics_rmi4_fn **fhandler,
		struct btn_synaptics_rmi4_fn_desc *rmi_fd, int page_number)
{
...
static int btn_synaptics_rmi4_query_device(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
	...
	bool f35found;
	bool was_in_bl_mode;
	struct btn_synaptics_rmi4_fn_desc rmi_fd;
	struct btn_synaptics_rmi4_fn *fhandler;
	struct btn_synaptics_rmi4_device_info *rmi;
...
rescan_pdt:
	...
	for (page_number = 0; page_number < PAGES_TO_SERVICE; page_number++) {
		for (pdt_entry_addr = PDT_START; pdt_entry_addr > PDT_END;
			...
			case BTN_SYNAPTICS_RMI4_F01:
				if (rmi_fd.intr_src_count == 0)
					break;

				f01found = true;

				retval = btn_synaptics_rmi4_alloc_fh(&fhandler,
						&rmi_fd, page_number);
				if (retval < 0) {
					dev_err(rmi4_data->pdev->dev.parent,
				...
				retval = btn_synaptics_rmi4_f01_init(rmi4_data,
			...
			case BTN_SYNAPTICS_RMI4_F11:
				...
				retval = btn_synaptics_rmi4_f11_init(rmi4_data,
						fhandler, &rmi_fd, intr_count);
				if (retval < 0)
					return retval;
				break;
			case BTN_SYNAPTICS_RMI4_F12:
				...
				retval = btn_synaptics_rmi4_f12_init(rmi4_data,
						fhandler, &rmi_fd, intr_count);
				if (retval < 0)
					return retval;
				break;
			case BTN_SYNAPTICS_RMI4_F1A:
				...
				retval = btn_synaptics_rmi4_f1a_init(rmi4_data,
						fhandler, &rmi_fd, intr_count);
				if (retval < 0) {
...
flash_prog_mode:
	...
	if (rmi->manufacturer_id != 1) {
		dev_err(rmi4_data->pdev->dev.parent,
				"%s: Non-BTN_Synaptics device found, manufacturer ID = %d\n",
	...
	rmi4_data->enable_wakeup_gesture = nubia_btn_wakeup_gesture;

	btn_synaptics_rmi4_set_configured(rmi4_data);
...
//nubia for pinctrl
#ifdef NUBIA_BTN_SYNAPTICS_PINCTRL
static int btn_synaptics_pinctrl_init(struct device *dev,
		struct btn_synaptics_rmi4_data *rmi4_data)
{
	...
	rmi4_data->pinctrl_info.pin_active = pinctrl_lookup_state(
					...
					BTN_SYNAPTICS_PINCTRL_STATE_ACTIVE);
	...
	rmi4_data->pinctrl_info.pin_suspend = pinctrl_lookup_state(
					rmi4_data->pinctrl_info.pinctrl,
					BTN_SYNAPTICS_PINCTRL_STATE_SUSPEND);
...
//nubia for pinctrl
static int btn_synaptics_pinctrl_set_state(
		struct btn_synaptics_rmi4_data *rmi4_data,
		bool active)
{
	int ret = -1;
...
static int btn_synaptics_rmi4_gpio_setup(int gpio, bool config, int dir, int state)
{
	int retval = 0;
...
static void btn_synaptics_rmi4_set_params(struct btn_synaptics_rmi4_data *rmi4_data)
{
	unsigned char ii;
	struct btn_synaptics_rmi4_f1a_handle *f1a;
	struct btn_synaptics_rmi4_fn *fhandler;
...
static int btn_synaptics_rmi4_set_input_dev(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
	const struct btn_synaptics_board_data *bdata =
				rmi4_data->hw_if->board_data;
	...
	retval = btn_synaptics_rmi4_query_device(rmi4_data);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
	...
	rmi4_data->input_dev->id.product = BTN_SYNAPTICS_DRIVER_PRODUCT;
	rmi4_data->input_dev->id.version = BTN_SYNAPTICS_DRIVER_VERSION;
	...
	btn_synaptics_rmi4_set_params(rmi4_data);
	...
	rmi4_data->stylus_dev->id.product = BTN_SYNAPTICS_DRIVER_PRODUCT;
	rmi4_data->stylus_dev->id.version = BTN_SYNAPTICS_DRIVER_VERSION;
...
err_register_input:
err_query_device:
	btn_synaptics_rmi4_empty_fn_list(rmi4_data);
...
static int btn_synaptics_rmi4_set_gpio(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
	const struct btn_synaptics_board_data *bdata =
			rmi4_data->hw_if->board_data;

	retval = btn_synaptics_rmi4_gpio_setup(
			bdata->irq_gpio,
			true, 0, 0);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
	...
	if (bdata->power_gpio_vdd >= 0) {
		...
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
					"%s: Failed to configure power GPIO vdd\n",
					__func__);
			goto err_gpio_power;
		}
	}
	...
	if (bdata->power_gpio_vcc >= 0) {
		retval = btn_synaptics_rmi4_gpio_setup(
				bdata->power_gpio_vcc,
				true, 1, bdata->power_on_state);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
					"%s: Failed to configure power GPIO vcc\n",
					__func__);
			goto err_gpio_power;
		}
	}
	...
	if (bdata->power_gpio_vcc >= 0) {
		gpio_set_value(bdata->power_gpio_vcc, bdata->power_on_state);
		msleep(bdata->power_delay_ms);
	}

	if (bdata->power_gpio_vdd >= 0) {
		gpio_set_value(bdata->power_gpio_vdd, bdata->power_on_state);
		msleep(bdata->power_delay_ms);
	}
...
err_gpio_reset:
	if (bdata->power_gpio_vcc >= 0)
		btn_synaptics_rmi4_gpio_setup(bdata->power_gpio_vcc, false, 0, 0);
	if (bdata->power_gpio_vdd >= 0)
		btn_synaptics_rmi4_gpio_setup(bdata->power_gpio_vdd, false, 0, 0);

err_gpio_power:
	btn_synaptics_rmi4_gpio_setup(bdata->irq_gpio, false, 0, 0);
...
static int btn_synaptics_rmi4_get_reg(struct btn_synaptics_rmi4_data *rmi4_data,
		bool get)
{
	int retval;
	const struct btn_synaptics_board_data *bdata =
	...
	if ((bdata->pwr_reg_name != NULL) && (*bdata->pwr_reg_name != 0)) {
		...
		if (regulator_count_voltages(rmi4_data->pwr_reg) > 0) {
			retval = regulator_set_voltage(rmi4_data->pwr_reg,
					BTN_SYNAPTICS_VDD_MIN_UV, BTN_SYNAPTICS_VDD_MAX_UV);
			if (retval) {
				dev_err(rmi4_data->pdev->dev.parent,
	...
	if ((bdata->bus_reg_name != NULL) && (*bdata->bus_reg_name != 0)) {
		...
		if (regulator_count_voltages(rmi4_data->bus_reg) > 0) {
			retval = regulator_set_voltage(rmi4_data->bus_reg,
					BTN_SYNAPTICS_VIO_MIN_UV, BTN_SYNAPTICS_VIO_MAX_UV);
			if (retval) {
				dev_err(rmi4_data->pdev->dev.parent,
...
static int btn_synaptics_rmi4_enable_reg(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
...
static int btn_synaptics_rmi4_sw_reset(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
...
static void btn_synaptics_rmi4_rebuild_work(struct work_struct *work)
{
	int retval;
	...
	struct btn_synaptics_rmi4_data *rmi4_data =
			container_of(delayed_work, struct btn_synaptics_rmi4_data,
			rb_work);

	btn_synaptics_rmi4_irq_enable(rmi4_data, false, false);
	...
	retval = btn_synaptics_rmi4_sw_reset(rmi4_data);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
	...
	retval = btn_synaptics_rmi4_set_input_dev(rmi4_data);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
...
exit:
	...
	btn_synaptics_rmi4_irq_enable(rmi4_data, true, false);
...
static int btn_synaptics_rmi4_reinit_device(struct btn_synaptics_rmi4_data *rmi4_data)
{
	...
	if (!list_empty(&rmi->support_fn_list)) {
		list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
			if (fhandler->fn_number == BTN_SYNAPTICS_RMI4_F12) {
				btn_synaptics_rmi4_f12_set_enables(rmi4_data, 0);
				break;
			}
		}
	}
...
static void btn_synaptics_rmi4_reset_work(struct work_struct *work)
{
	int retval;
	unsigned int timeout;
	struct btn_synaptics_rmi4_data *rmi4_data =
			container_of(work, struct btn_synaptics_rmi4_data,
			reset_work);
...
static void btn_synaptics_rmi4_sleep_enable(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
	unsigned char device_ctrl;
...
static void btn_synaptics_rmi4_exp_fn_work(struct work_struct *work)
{
	struct btn_synaptics_rmi4_exp_fhandler *exp_fhandler;
	struct btn_synaptics_rmi4_exp_fhandler *exp_fhandler_temp;
	struct btn_synaptics_rmi4_data *rmi4_data = exp_data.rmi4_data;
...
void btn_synaptics_rmi4_new_function(struct btn_synaptics_rmi4_exp_fn *exp_fn,
		bool insert)
{
	struct btn_synaptics_rmi4_exp_fhandler *exp_fhandler;
...
EXPORT_SYMBOL(btn_synaptics_rmi4_new_function);

static int btn_synaptics_rmi4_probe(struct platform_device *pdev)
{
	int retval;
	unsigned char attr_count;
	struct btn_synaptics_rmi4_data *rmi4_data;
	const struct btn_synaptics_hw_interface *hw_if;
	const struct btn_synaptics_board_data *bdata;
	...
	rmi4_data->reset_device = btn_synaptics_rmi4_reset_device;
	rmi4_data->irq_enable = btn_synaptics_rmi4_irq_enable;
	rmi4_data->sleep_enable = btn_synaptics_rmi4_sleep_enable;
...
//nubia for synaptics pinctrl
#ifdef NUBIA_BTN_SYNAPTICS_PINCTRL
	retval = btn_synaptics_pinctrl_init(pdev->dev.parent, rmi4_data);
	if (retval < 0) {
		pr_err("%s: synaptics pinctrl init failed.\n", __func__);
		goto pinctrl_init_failed;
	}
	retval = btn_synaptics_pinctrl_set_state(rmi4_data, true);
	if (retval) {
	...
	retval = btn_synaptics_rmi4_get_reg(rmi4_data, true);
	if (retval < 0) {
		dev_err(&pdev->dev,
	...
	retval = btn_synaptics_rmi4_enable_reg(rmi4_data, true);
	if (retval < 0) {
		dev_err(&pdev->dev,
	...
	retval = btn_synaptics_rmi4_set_gpio(rmi4_data);
	if (retval < 0) {
		dev_err(&pdev->dev,
...
#ifdef CONFIG_FB
	rmi4_data->fb_notifier.notifier_call = btn_synaptics_rmi4_fb_notifier_cb;
	...
	rmi4_data->early_suspend.suspend = btn_synaptics_rmi4_early_suspend;
	rmi4_data->early_suspend.resume = btn_synaptics_rmi4_late_resume;
	...
	retval = btn_synaptics_rmi4_irq_enable(rmi4_data, true, false);
	if (retval < 0) {
		dev_err(&pdev->dev,
       ...
       pr_debug("%s irq = %d ",__func__,rmi4_data->irq);
	if (vir_button_map->nbuttons) {
	...
	INIT_DELAYED_WORK(&rmi4_data->rb_work, btn_synaptics_rmi4_rebuild_work);

	exp_data.workqueue = create_singlethread_workqueue("dsx_exp_workqueue");
	INIT_DELAYED_WORK(&exp_data.work, btn_synaptics_rmi4_exp_fn_work);
	...
	INIT_WORK(&rmi4_data->reset_work, btn_synaptics_rmi4_reset_work);
	...
	INIT_WORK(&rmi4_data->resume_work, btn_synaptics_rmi4_resume_work);
#endif
...
err_set_input_dev:
	...
	if (bdata->reset_gpio >= 0)
		btn_synaptics_rmi4_gpio_setup(bdata->reset_gpio, false, 0, 0);
...
err_ui_hw_init:
err_set_gpio:
	btn_synaptics_rmi4_enable_reg(rmi4_data, false);

err_enable_reg:
	btn_synaptics_rmi4_get_reg(rmi4_data, false);
...
static int btn_synaptics_rmi4_remove(struct platform_device *pdev)
{
	unsigned char attr_count;
	struct btn_synaptics_rmi4_data *rmi4_data = platform_get_drvdata(pdev);
	const struct btn_synaptics_board_data *bdata =
			rmi4_data->hw_if->board_data;
...
static void btn_synaptics_rmi4_f11_wg(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
	...
	list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
		if (fhandler->fn_number == BTN_SYNAPTICS_RMI4_F11)
			break;
	}
...
static void btn_synaptics_rmi4_f12_wg(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
	unsigned char offset;
...
static void btn_synaptics_rmi4_wakeup_gesture(struct btn_synaptics_rmi4_data *rmi4_data,
		bool enable)
{
	if (rmi4_data->f11_wakeup_gesture)
		btn_synaptics_rmi4_f11_wg(rmi4_data, enable);
	else if (rmi4_data->f12_wakeup_gesture)
		btn_synaptics_rmi4_f12_wg(rmi4_data, enable);
...
static void btn_synaptics_rmi4_resume_work(struct work_struct *work)
{
	struct btn_synaptics_rmi4_data *rmi4_data =container_of(work, struct btn_synaptics_rmi4_data, resume_work);
	btn_synaptics_rmi4_resume(&rmi4_data->pdev->dev);
		...
		unsigned long event, void *data)
{
	...
	struct btn_synaptics_rmi4_data *rmi4_data =
			container_of(self, struct btn_synaptics_rmi4_data,
			fb_notifier);
	struct btn_synaptics_rmi4_device_info *rmi;
	rmi = &(rmi4_data->rmi4_mod_info);
		...
		if(!strncmp(rmi->product_id_string, "NUBIA-JDI", 9)) {
			if (event == FB_EVENT_BLANK) {
				...
				if (*transition == FB_BLANK_POWERDOWN) {
					flush_workqueue(rmi4_data->resume_workqueue);
					btn_synaptics_rmi4_suspend(&rmi4_data->pdev->dev);
				...
				if (*transition == FB_BLANK_UNBLANK) {
					queue_work(rmi4_data->resume_workqueue, &rmi4_data->resume_work);
				}
			}
		} else {
...
static void btn_synaptics_rmi4_early_suspend(struct early_suspend *h)
{
	struct btn_synaptics_rmi4_exp_fhandler *exp_fhandler;
	struct btn_synaptics_rmi4_data *rmi4_data =
			container_of(h, struct btn_synaptics_rmi4_data,
			early_suspend);
	...
	if (rmi4_data->enable_wakeup_gesture) {
		btn_synaptics_rmi4_wakeup_gesture(rmi4_data, true);
	...
	btn_synaptics_rmi4_irq_enable(rmi4_data, false, false);
	btn_synaptics_rmi4_sleep_enable(rmi4_data, true);
	btn_synaptics_rmi4_free_fingers(rmi4_data);
...
static void btn_synaptics_rmi4_late_resume(struct early_suspend *h)
{
	...
	if (rmi4_data->enable_wakeup_gesture) {
		btn_synaptics_rmi4_wakeup_gesture(rmi4_data, false);
	...
	if (rmi4_data->suspend) {
		btn_synaptics_rmi4_sleep_enable(rmi4_data, false);
		btn_synaptics_rmi4_irq_enable(rmi4_data, true, false);
	}
...
static int btn_synaptics_rmi4_suspend(struct device *dev)
{
...
#ifdef NUBIA_BTN_SYNAPTICS_PINCTRL
	if (btn_synaptics_pinctrl_set_state(rmi4_data, false)) {
	...
	if (!rmi4_data->suspend) {
		...
		if (rmi4_data->hw_if->board_data->power_gpio_vdd >= 0) {
			ret = btn_synaptics_rmi4_gpio_setup(
					rmi4_data->hw_if->board_data->power_gpio_vdd,
					false, 0, 0);
			if (ret < 0) {
				dev_err(rmi4_data->pdev->dev.parent,
					"[TP]%s: failed to set power_gpio_vdd low!\n",
					__func__);
			}
		}
...
static int btn_synaptics_rmi4_resume(struct device *dev)
{
...
#ifdef NUBIA_BTN_SYNAPTICS_PINCTRL
	if (btn_synaptics_pinctrl_set_state(rmi4_data, true)) {
	...
	if(rmi4_data->suspend) {
		if (rmi4_data->hw_if->board_data->power_gpio_vdd >= 0) {
			...
			if (ret < 0) {
				dev_err(rmi4_data->pdev->dev.parent,
					"[TP]%s: failed to set power_gpio_vdd high!\n",
					__func__);
			}
		}

		btn_synaptics_rmi4_enable_reg(rmi4_data, true);
		msleep(10);
...
exit:
	ret = btn_synaptics_rmi4_reset_device(rmi4_data, false);
	if (ret < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
				"%s: Failed to issue reset command\n",
				__func__);
...
#ifdef CONFIG_PM
static const struct dev_pm_ops btn_synaptics_rmi4_dev_pm_ops = {
#ifndef CONFIG_FB
	.suspend = btn_synaptics_rmi4_suspend,
	.resume = btn_synaptics_rmi4_resume,
#endif
};
#endif

static struct platform_driver btn_synaptics_rmi4_driver = {
	.driver = {
		.name = PLATFORM_DRIVER_NAME,
		.owner = THIS_MODULE,
#ifdef CONFIG_PM
		.pm = &btn_synaptics_rmi4_dev_pm_ops,
#endif
	},
	.probe = btn_synaptics_rmi4_probe,
	.remove = btn_synaptics_rmi4_remove,
};

static int __init btn_synaptics_rmi4_init(void)
{
	int retval;
	retval = btn_synaptics_rmi4_bus_init();
	if (retval)
		return retval;

	return platform_driver_register(&btn_synaptics_rmi4_driver);
}

static void __exit btn_synaptics_rmi4_exit(void)
{
	platform_driver_unregister(&btn_synaptics_rmi4_driver);

	btn_synaptics_rmi4_bus_exit();

	return;
}

module_init(btn_synaptics_rmi4_init);
module_exit(btn_synaptics_rmi4_exit);

MODULE_AUTHOR("BTN_Synaptics, Inc.");
MODULE_DESCRIPTION("BTN_Synaptics DSX Touch Driver");
