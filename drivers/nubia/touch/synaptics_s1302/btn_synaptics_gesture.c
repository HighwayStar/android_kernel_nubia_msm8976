...
#define GESTURE_PHYS_NAME "btn_synaptics_/gesture"
...
struct btn_synaptics_rmi4_f12_query_0 {
	union {
		struct {
			struct {
...
struct btn_synaptics_rmi4_f12_control_41 {
	union {
		struct {
...
struct btn_synaptics_rmi4_udg_handle {
	atomic_t attn_event;
...
static struct btn_synaptics_rmi4_udg_handle *udg;
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	bool enable;
	unsigned int input;
	struct btn_synaptics_rmi4_f12_control_41 control_41;
	struct btn_synaptics_rmi4_data *rmi4_data = udg->rmi4_data;
...
static int udg_reg_init(void)
{
	...
	struct btn_synaptics_rmi4_f12_query_0 query_0;
	struct btn_synaptics_rmi4_f12_query_5 query_5;
	struct btn_synaptics_rmi4_f12_query_8 query_8;
	struct btn_synaptics_rmi4_data *rmi4_data = udg->rmi4_data;
...
static void btn_synaptics_rmi4_udg_attn(struct btn_synaptics_rmi4_data *rmi4_data,
		unsigned char intr_mask)
{
	if (!udg)
		return;
...
static int btn_synaptics_rmi4_udg_init(struct btn_synaptics_rmi4_data *rmi4_data)
{
	int retval;
	unsigned char ii;
	unsigned char size;
	...
	udg->udg_dev->id.product = BTN_SYNAPTICS_DRIVER_PRODUCT;
	udg->udg_dev->id.version = BTN_SYNAPTICS_DRIVER_VERSION;
...
static void btn_synaptics_rmi4_udg_remove(struct btn_synaptics_rmi4_data *rmi4_data)
{
	unsigned char count;
...
static void btn_synaptics_rmi4_udg_reset(struct btn_synaptics_rmi4_data *rmi4_data)
{
	if (!udg) {
		btn_synaptics_rmi4_udg_init(rmi4_data);
		return;
	}
...
static void btn_synaptics_rmi4_udg_reinit(struct btn_synaptics_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void btn_synaptics_rmi4_udg_e_suspend(struct btn_synaptics_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void btn_synaptics_rmi4_udg_suspend(struct btn_synaptics_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void btn_synaptics_rmi4_udg_resume(struct btn_synaptics_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void btn_synaptics_rmi4_udg_l_resume(struct btn_synaptics_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static struct btn_synaptics_rmi4_exp_fn gesture_module = {
	.fn_type = RMI_GESTURE,
	.init = btn_synaptics_rmi4_udg_init,
	.remove = btn_synaptics_rmi4_udg_remove,
	.reset = btn_synaptics_rmi4_udg_reset,
	.reinit = btn_synaptics_rmi4_udg_reinit,
	.early_suspend = btn_synaptics_rmi4_udg_e_suspend,
	.suspend = btn_synaptics_rmi4_udg_suspend,
	.resume = btn_synaptics_rmi4_udg_resume,
	.late_resume = btn_synaptics_rmi4_udg_l_resume,
	.attn = btn_synaptics_rmi4_udg_attn,
};

static int __init rmi4_gesture_module_init(void)
{
	btn_synaptics_rmi4_new_function(&gesture_module, true);
...
{
	btn_synaptics_rmi4_new_function(&gesture_module, false);
...
MODULE_DESCRIPTION("BTN_Synaptics DSX User Defined Gesture Module");
