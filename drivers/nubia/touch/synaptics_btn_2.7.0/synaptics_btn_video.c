...
struct synaptics_btn_rmi4_video_handle {
	unsigned char param;
...
static struct synaptics_btn_rmi4_video_handle *video;
...
static int video_send_dcs_command(unsigned char command_opcode)
{
	...
	struct synaptics_btn_rmi4_data *rmi4_data = video->rmi4_data;
...
static int synaptics_btn_rmi4_video_init(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
...
static void synaptics_btn_rmi4_video_remove(struct synaptics_btn_rmi4_data *rmi4_data)
{
	unsigned char attr_count;
...
static void synaptics_btn_rmi4_video_reset(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!video)
		synaptics_btn_rmi4_video_init(rmi4_data);

	return;
}

#ifdef RMI_DCS_SUSPEND_RESUME
static void synaptics_btn_rmi4_video_suspend(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	unsigned char ii;
	unsigned char command;
...
static void synaptics_btn_rmi4_video_resume(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	unsigned char ii;
	unsigned char command;
...
static struct synaptics_btn_rmi4_exp_fn video_module = {
	.fn_type = RMI_VIDEO,
	.init = synaptics_btn_rmi4_video_init,
	.remove = synaptics_btn_rmi4_video_remove,
	.reset = synaptics_btn_rmi4_video_reset,
	.reinit = NULL,
	.early_suspend = NULL,
#ifdef RMI_DCS_SUSPEND_RESUME
	.suspend = synaptics_btn_rmi4_video_suspend,
	.resume = synaptics_btn_rmi4_video_resume,
#else
	.suspend = NULL,
	.resume = NULL,
#endif
...
{
	synaptics_btn_rmi4_new_function(&video_module, true);
...
{
	synaptics_btn_rmi4_new_function(&video_module, false);
...
MODULE_DESCRIPTION("Synaptics Button DSX Video Module");
