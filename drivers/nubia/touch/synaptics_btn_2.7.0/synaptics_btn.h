...
#ifndef _SYNAPTICS_BTN_H_
#define _SYNAPTICS_BTN_H_

#ifndef NUBIA_TOUCH_SYNAPTICS
#define NUBIA_TOUCH_SYNAPTICS
#endif

#define PLATFORM_DRIVER_NAME "synaptics_btn"
#define STYLUS_DRIVER_NAME "synaptics_btn_stylus"
#define ACTIVE_PEN_DRIVER_NAME "synaptics_btn_active_pen"
#define PROXIMITY_DRIVER_NAME "synaptics_btn_proximity"
#define GESTURE_DRIVER_NAME "synaptics_btn_gesture"
#define I2C_DRIVER_NAME "synaptics_btn_i2c"
#define SPI_DRIVER_NAME "synaptics_btn_spi"

/*
 * struct synaptics_btn_button_map - button map
 * @nbuttons: number of buttons
 * @map: pointer to array of button codes
 */
struct synaptics_btn_button_map {
...
/*
 * struct synaptics_btn_board_data - DSX board data
 * @x_flip: x flip flag
 * @y_flip: y flip flag
 ...
 */
struct synaptics_btn_board_data {
	bool x_flip;
	bool y_flip;
	bool swap_axes;
	int irq_gpio;
	...
	struct synaptics_btn_button_map *cap_button_map;
	struct synaptics_btn_button_map *vir_button_map;
#ifdef NUBIA_TOUCH_SYNAPTICS
