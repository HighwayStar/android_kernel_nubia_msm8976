/*
 * Synaptics Button DSX touchscreen driver
 *
...
#include "synaptics_btn.h"
#include "synaptics_btn_core.h"
...
#define INPUT_PHYS_NAME "synaptics_btn/touch_input"
#define STYLUS_PHYS_NAME "synaptics_btn/stylus"
...
#ifdef NUBIA_TOUCH_SYNAPTICS
#define SYNAPTICS_PINCTRL_STATE_SUSPEND "touch_button_pin_suspend"
#define SYNAPTICS_PINCTRL_STATE_ACTIVE "touch_button_pin_active"
#endif
...
static int synaptics_btn_rmi4_check_status(struct synaptics_btn_rmi4_data *rmi4_data,
		bool *was_in_bl_mode);
static int synaptics_btn_rmi4_free_fingers(struct synaptics_btn_rmi4_data *rmi4_data);
static int synaptics_btn_rmi4_reinit_device(struct synaptics_btn_rmi4_data *rmi4_data);
static int synaptics_btn_rmi4_reset_device(struct synaptics_btn_rmi4_data *rmi4_data,
		bool rebuild);

#ifdef CONFIG_FB
static int synaptics_btn_rmi4_fb_notifier_cb(struct notifier_block *self,
		unsigned long event, void *data);
#endif

#ifdef NUBIA_TOUCH_SYNAPTICS
static int synaptics_btn_rmi4_power_notifier_cb(struct notifier_block *self,
		unsigned long event, void *data);
#endif
...
static void synaptics_btn_rmi4_early_suspend(struct early_suspend *h);

static void synaptics_btn_rmi4_late_resume(struct early_suspend *h);
#endif

static int synaptics_btn_rmi4_suspend(struct device *dev);

static int synaptics_btn_rmi4_resume(struct device *dev);

static ssize_t synaptics_btn_rmi4_f01_reset_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t synaptics_btn_rmi4_f01_productinfo_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_f01_buildid_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_f01_flashprog_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_0dbutton_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_0dbutton_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t synaptics_btn_rmi4_suspend_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static ssize_t synaptics_btn_rmi4_wake_gesture_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_wake_gesture_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

#ifdef USE_DATA_SERVER
static ssize_t synaptics_btn_rmi4_synad_pid_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);
#endif

static ssize_t synaptics_btn_rmi4_virtual_key_map_show(struct kobject *kobj,
		struct kobj_attribute *attr, char *buf);

#ifdef NUBIA_TOUCH_SYNAPTICS
static ssize_t synaptics_btn_rmi4_palm_sleep_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_palm_sleep_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);
#endif

struct synaptics_btn_rmi4_f01_device_status {
	union {
		struct {
...
struct synaptics_btn_rmi4_f11_query_0_5 {
	union {
		struct {
			/* query 0 */
...
struct synaptics_btn_rmi4_f11_query_7_8 {
	union {
		struct {
			/* query 7 */
...
struct synaptics_btn_rmi4_f11_query_9 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f11_query_12 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f11_query_27 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f11_ctrl_6_9 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f11_data_1_5 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f12_query_5 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f12_query_8 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f12_ctrl_8 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f12_ctrl_23 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f12_ctrl_31 {
	union {
		struct {
			unsigned char max_x_coord_lsb;
			unsigned char max_x_coord_msb;
...
struct synaptics_btn_rmi4_f12_ctrl_58 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f12_finger_data {
...
struct synaptics_btn_rmi4_f1a_query {
	union {
		struct {
...
struct synaptics_btn_rmi4_f1a_query_4 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f1a_control_0 {
	union {
		struct {
...
struct synaptics_btn_rmi4_f1a_control {
	struct synaptics_btn_rmi4_f1a_control_0 general_control;
...
struct synaptics_btn_rmi4_f1a_handle {
	int button_bitmask_size;
	unsigned char max_count;
	unsigned char valid_button_count;
	unsigned char *button_data_buffer;
	unsigned char *button_map;
	struct synaptics_btn_rmi4_f1a_query button_query;
	struct synaptics_btn_rmi4_f1a_control button_control;
};

struct synaptics_btn_rmi4_exp_fhandler {
	struct synaptics_btn_rmi4_exp_fn *exp_fn;
	bool insert;
	bool remove;
	struct list_head link;
};

struct synaptics_btn_rmi4_exp_fn_data {
	bool initialized;
	bool queue_work;
	struct mutex mutex;
	...
	struct synaptics_btn_rmi4_data *rmi4_data;
};

static struct synaptics_btn_rmi4_exp_fn_data exp_data;

static struct synaptics_btn_button_map *vir_button_map;
...
static struct device_attribute attrs[] = {
	__ATTR(reset, (S_IWUSR | S_IWGRP),
			synaptics_btn_rmi4_show_error,
			synaptics_btn_rmi4_f01_reset_store),
	__ATTR(productinfo, S_IRUGO,
			synaptics_btn_rmi4_f01_productinfo_show,
			synaptics_btn_rmi4_store_error),
	__ATTR(buildid, S_IRUGO,
			synaptics_btn_rmi4_f01_buildid_show,
			synaptics_btn_rmi4_store_error),
	__ATTR(flashprog, S_IRUGO,
			synaptics_btn_rmi4_f01_flashprog_show,
			synaptics_btn_rmi4_store_error),
	__ATTR(0dbutton, (S_IRUGO | S_IWUSR | S_IWGRP),
			synaptics_btn_rmi4_0dbutton_show,
			synaptics_btn_rmi4_0dbutton_store),
	__ATTR(suspend, (S_IWUSR | S_IWGRP),
			synaptics_btn_rmi4_show_error,
			synaptics_btn_rmi4_suspend_store),
	__ATTR(wake_gesture, (S_IRUGO | S_IWUSR | S_IWGRP),
			synaptics_btn_rmi4_wake_gesture_show,
			synaptics_btn_rmi4_wake_gesture_store),
#ifdef USE_DATA_SERVER
	__ATTR(synad_pid, (S_IWUSR | S_IWGRP),
			synaptics_btn_rmi4_show_error,
			synaptics_btn_rmi4_synad_pid_store),
#endif
#ifdef NUBIA_TOUCH_SYNAPTICS
	__ATTR(palm_sleep, (S_IRUGO | S_IWUSR | S_IWGRP),
			synaptics_btn_rmi4_palm_sleep_show,
			synaptics_btn_rmi4_palm_sleep_store),
#endif
};
...
static struct kobj_attribute virtual_key_map_attr = {
	...
	.show = synaptics_btn_rmi4_virtual_key_map_show,
};
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	int retval;
	unsigned int reset;
	struct synaptics_btn_rmi4_data *rmi4_data = dev_get_drvdata(dev);
	...
	retval = synaptics_btn_rmi4_reset_device(rmi4_data, false);
	if (retval < 0) {
...
{
	int retval;
	struct synaptics_btn_rmi4_f01_device_status device_status;
	struct synaptics_btn_rmi4_data *rmi4_data = dev_get_drvdata(dev);

	retval = synaptics_btn_rmi4_reg_read(rmi4_data,
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	struct synaptics_btn_rmi4_fn *fhandler;
	struct synaptics_btn_rmi4_data *rmi4_data = dev_get_drvdata(dev);
	struct synaptics_btn_rmi4_device_info *rmi;
	...
	list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
		if (fhandler->fn_number == SYNAPTICS_RMI4_F1A) {
			...
			retval = synaptics_btn_rmi4_reg_write(rmi4_data,
					rmi4_data->f01_ctrl_base_addr + 1 + ii,
					&intr_enable,
					sizeof(intr_enable));
			if (retval < 0)
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if (input == 1)
		synaptics_btn_rmi4_suspend(dev);
	else if (input == 0)
		synaptics_btn_rmi4_resume(dev);
	else
		return -EINVAL;
...
#ifdef NUBIA_TOUCH_SYNAPTICS
static int nubia_wakeup_gesture = 0;
#endif
static ssize_t synaptics_btn_rmi4_wake_gesture_show(struct device *dev,
		struct device_attribute *attr, char *buf)
{
...
#ifdef NUBIA_TOUCH_SYNAPTICS
bool btn_nubia_enable_wakeup_gesture(void)
{
	return (nubia_wakeup_gesture == 1) ? true : false;
}
...
static void synaptics_btn_rmi4_f11_wg(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
...
static void synaptics_btn_rmi4_f12_wg(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
	unsigned char offset;
	unsigned char reporting_control[3];
	struct synaptics_btn_rmi4_f12_extra_data *extra_data;
	struct synaptics_btn_rmi4_fn *fhandler;
	struct synaptics_btn_rmi4_device_info *rmi;
	...
	extra_data = (struct synaptics_btn_rmi4_f12_extra_data *)fhandler->extra;
...
static void synaptics_btn_rmi4_wakeup_gesture(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	if (rmi4_data->f11_wakeup_gesture)
		synaptics_btn_rmi4_f11_wg(rmi4_data, enable);
	else if (rmi4_data->f12_wakeup_gesture)
		synaptics_btn_rmi4_f12_wg(rmi4_data, enable);

	return;
}

#ifdef NUBIA_TOUCH_SYNAPTICS
static bool synaptics_f12_palm_touch(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
...
static int report_palm_event(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int ret;
...
static int synaptics_btn_rmi4_f11_abs_report(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler)
{
	int retval;
	...
	int wy;
	int temp;
	struct synaptics_btn_rmi4_f11_data_1_5 data;
	struct synaptics_btn_rmi4_f11_extra_data *extra_data;
	...
	extra_data = (struct synaptics_btn_rmi4_f11_extra_data *)fhandler->extra;
	...
	if (rmi4_data->suspend && rmi4_data->enable_wakeup_gesture) {
		...
		synaptics_btn_rmi4_wakeup_gesture(rmi4_data, false);
		return 0;
	}
...
static int synaptics_btn_rmi4_f12_abs_report(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler)
{
	int retval;
	unsigned char touch_count = 0; /* number of touch points */
...
#endif
	struct synaptics_btn_rmi4_f12_extra_data *extra_data;
	struct synaptics_btn_rmi4_f12_finger_data *data;
	struct synaptics_btn_rmi4_f12_finger_data *finger_data;
	...
	data_addr = fhandler->full_addr.data_base;
	extra_data = (struct synaptics_btn_rmi4_f12_extra_data *)fhandler->extra;
	size_of_2d_data = sizeof(struct synaptics_btn_rmi4_f12_finger_data);
	...
	if (rmi4_data->suspend && rmi4_data->enable_wakeup_gesture) {
		...
		if (gesture_type && gesture_type != F12_UDG_DETECT) {
			...
			input_sync(rmi4_data->input_dev);
			pr_info("synaptics wakeup gesture detected !\n");
#else
			input_report_key(rmi4_data->input_dev, KEY_WAKEUP, 1);
			input_sync(rmi4_data->input_dev);
			input_report_key(rmi4_data->input_dev, KEY_WAKEUP, 0);
	...
	if (!fingers_to_process) {
		synaptics_btn_rmi4_free_fingers(rmi4_data);
		finger_presence = 0;
		stylus_presence = 0;
		return 0;
	}
	...
	data = (struct synaptics_btn_rmi4_f12_finger_data *)fhandler->data;
...
static void synaptics_btn_rmi4_f1a_report(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler)
{
	int retval;
	...
	struct synaptics_btn_rmi4_f1a_handle *f1a = fhandler->data;
...
static void synaptics_btn_rmi4_report_touch(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler)
{
	...
	case SYNAPTICS_RMI4_F11:
		touch_count_2d = synaptics_btn_rmi4_f11_abs_report(rmi4_data,
				fhandler);
	...
	case SYNAPTICS_RMI4_F12:
		touch_count_2d = synaptics_btn_rmi4_f12_abs_report(rmi4_data,
				fhandler);
	...
	case SYNAPTICS_RMI4_F1A:
		synaptics_btn_rmi4_f1a_report(rmi4_data, fhandler);
		break;
#ifdef USE_DATA_SERVER
...
static void synaptics_btn_rmi4_sensor_report(struct synaptics_btn_rmi4_data *rmi4_data,
		bool report)
{
	int retval;
	...
	bool was_in_bl_mode;
	struct synaptics_btn_rmi4_f01_device_status status;
	struct synaptics_btn_rmi4_fn *fhandler;
	struct synaptics_btn_rmi4_exp_fhandler *exp_fhandler;
	struct synaptics_btn_rmi4_device_info *rmi;
	...
	if (status.status_code == STATUS_CRC_IN_PROGRESS) {
		retval = synaptics_btn_rmi4_check_status(rmi4_data,
				&was_in_bl_mode);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
	...
	if (status.unconfigured && !status.flash_prog) {
		...
		retval = synaptics_btn_rmi4_reinit_device(rmi4_data);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
		...
		list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
			if (fhandler->num_of_data_sources) {
				if (fhandler->intr_mask &
					...
					synaptics_btn_rmi4_report_touch(rmi4_data,
							fhandler);
				}
			}
		}
...
static irqreturn_t synaptics_btn_rmi4_irq(int irq, void *data)
{
	struct synaptics_btn_rmi4_data *rmi4_data = data;
	const struct synaptics_btn_board_data *bdata =
			rmi4_data->hw_if->board_data;

	if (gpio_get_value(bdata->irq_gpio) != bdata->irq_on_state)
		goto exit;

	synaptics_btn_rmi4_sensor_report(rmi4_data, true);

exit:
	return IRQ_HANDLED;
}

static int synaptics_btn_rmi4_int_enable(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval = 0;
	unsigned char ii;
...
static int synaptics_btn_rmi4_irq_enable(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable, bool attn_only)
{
	...
	if (attn_only) {
		retval = synaptics_btn_rmi4_int_enable(rmi4_data, enable);
		goto exit;
	}
	...
	if (enable) {
		...
		retval = synaptics_btn_rmi4_int_enable(rmi4_data, false);
		if (retval < 0)
			goto exit;
		...
		retval = request_threaded_irq(rmi4_data->irq, NULL,
				synaptics_btn_rmi4_irq, bdata->irq_flags,
		...
		retval = synaptics_btn_rmi4_int_enable(rmi4_data, true);
		if (retval < 0)
			goto exit;
...
static void synaptics_btn_rmi4_set_intr_mask(struct synaptics_btn_rmi4_fn *fhandler,
		struct synaptics_btn_rmi4_fn_desc *fd,
...
static int synaptics_btn_rmi4_f01_init(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler,
		struct synaptics_btn_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	synaptics_btn_rmi4_set_intr_mask(fhandler, fd, intr_count);
...
static int synaptics_btn_rmi4_f11_init(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler,
		struct synaptics_btn_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	unsigned char fingers_supported;
	struct synaptics_btn_rmi4_f11_extra_data *extra_data;
	struct synaptics_btn_rmi4_f11_query_0_5 query_0_5;
	struct synaptics_btn_rmi4_f11_query_7_8 query_7_8;
	struct synaptics_btn_rmi4_f11_query_9 query_9;
	struct synaptics_btn_rmi4_f11_query_12 query_12;
	struct synaptics_btn_rmi4_f11_query_27 query_27;
	struct synaptics_btn_rmi4_f11_ctrl_6_9 control_6_9;
	const struct synaptics_btn_board_data *bdata =
				rmi4_data->hw_if->board_data;
...
static int synaptics_btn_rmi4_f12_set_enables(struct synaptics_btn_rmi4_data *rmi4_data,
...
static int synaptics_btn_rmi4_f12_find_sub(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler,
...
static int synaptics_btn_rmi4_f12_init(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler,
		struct synaptics_btn_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	struct synaptics_btn_rmi4_f12_extra_data *extra_data;
	struct synaptics_btn_rmi4_f12_query_5 *query_5 = NULL;
	struct synaptics_btn_rmi4_f12_query_8 *query_8 = NULL;
	struct synaptics_btn_rmi4_f12_ctrl_8 *ctrl_8 = NULL;
	struct synaptics_btn_rmi4_f12_ctrl_23 *ctrl_23 = NULL;
	struct synaptics_btn_rmi4_f12_ctrl_31 *ctrl_31 = NULL;
	struct synaptics_btn_rmi4_f12_ctrl_58 *ctrl_58 = NULL;
	const struct synaptics_btn_board_data *bdata =
				rmi4_data->hw_if->board_data;
	...
	for (subpacket = 2; subpacket <= 4; subpacket++) {
		retval = synaptics_btn_rmi4_f12_find_sub(rmi4_data,
	...
	retval = synaptics_btn_rmi4_f12_set_enables(rmi4_data,
...
static int synaptics_btn_rmi4_f1a_alloc_mem(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler)
{
	int retval;
	struct synaptics_btn_rmi4_f1a_handle *f1a;
...
static int synaptics_btn_rmi4_f1a_button_map(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler)
{
	int retval;
	unsigned char ii;
	unsigned char offset = 0;
	struct synaptics_btn_rmi4_f1a_query_4 query_4;
	struct synaptics_btn_rmi4_f1a_handle *f1a = fhandler->data;
	const struct synaptics_btn_board_data *bdata =
			rmi4_data->hw_if->board_data;
...
static void synaptics_btn_rmi4_f1a_kfree(struct synaptics_btn_rmi4_fn *fhandler)
{
	struct synaptics_btn_rmi4_f1a_handle *f1a = fhandler->data;
...
static int synaptics_btn_rmi4_f1a_init(struct synaptics_btn_rmi4_data *rmi4_data,
		struct synaptics_btn_rmi4_fn *fhandler,
		struct synaptics_btn_rmi4_fn_desc *fd,
		unsigned int intr_count)
{
	...
	retval = synaptics_btn_rmi4_f1a_alloc_mem(rmi4_data, fhandler);
	if (retval < 0)
		goto error_exit;

	retval = synaptics_btn_rmi4_f1a_button_map(rmi4_data, fhandler);
	if (retval < 0)
		goto error_exit;
...
error_exit:
	synaptics_btn_rmi4_f1a_kfree(fhandler);

	return retval;
}

static void synaptics_btn_rmi4_empty_fn_list(struct synaptics_btn_rmi4_data *rmi4_data)
{
	struct synaptics_btn_rmi4_fn *fhandler;
	struct synaptics_btn_rmi4_fn *fhandler_temp;
	struct synaptics_btn_rmi4_device_info *rmi;
...
static void synaptics_btn_rmi4_set_configured(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
...
static int synaptics_btn_rmi4_alloc_fh(struct synaptics_btn_rmi4_fn **fhandler,
		struct synaptics_btn_rmi4_fn_desc *rmi_fd, int page_number)
{
...
static int synaptics_btn_rmi4_query_device(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	...
	bool f35found;
	bool was_in_bl_mode;
	struct synaptics_btn_rmi4_fn_desc rmi_fd;
	struct synaptics_btn_rmi4_fn *fhandler;
	struct synaptics_btn_rmi4_device_info *rmi;
	...
	for (page_number = 0; page_number < PAGES_TO_SERVICE; page_number++) {
		for (pdt_entry_addr = PDT_START; pdt_entry_addr > PDT_END;
			...
			case SYNAPTICS_RMI4_F01:
				...
				retval = synaptics_btn_rmi4_alloc_fh(&fhandler,
						&rmi_fd, page_number);
				if (retval < 0) {
					dev_err(rmi4_data->pdev->dev.parent,
				...
				retval = synaptics_btn_rmi4_f01_init(rmi4_data,
			...
			case SYNAPTICS_RMI4_F11:
				...
				retval = synaptics_btn_rmi4_f11_init(rmi4_data,
						fhandler, &rmi_fd, intr_count);
				if (retval < 0)
					return retval;
				break;
			case SYNAPTICS_RMI4_F12:
				...
				retval = synaptics_btn_rmi4_f12_init(rmi4_data,
						fhandler, &rmi_fd, intr_count);
				if (retval < 0)
					return retval;
				break;
			case SYNAPTICS_RMI4_F1A:
				...
				retval = synaptics_btn_rmi4_f1a_init(rmi4_data,
						fhandler, &rmi_fd, intr_count);
				if (retval < 0) {
			...
			case SYNAPTICS_RMI4_F21:
				...
				synaptics_btn_rmi4_set_intr_mask(fhandler, &rmi_fd,
						intr_count);
				break;
#endif
...
flash_prog_mode:
	...
	synaptics_btn_rmi4_set_configured(rmi4_data);
		...
		struct synaptics_btn_rmi4_data *rmi4_data)
{
	...
	if (IS_ERR_OR_NULL(rmi4_data->pinctrl_info.pinctrl)) {
		pr_err("%s:synaptics get pinctrl info error.\n", __func__);
		return -EINVAL;
	}
	...
	if (IS_ERR_OR_NULL(rmi4_data->pinctrl_info.pin_active)) {
		pr_err("%s : synaptics get pin_active info error.\n",__func__);
		return -EINVAL;
	}
	...
	if (IS_ERR_OR_NULL(rmi4_data->pinctrl_info.pin_suspend)) {
		pr_err("%s : synaptics get pin_suspend info error.\n",__func__);
		return -EINVAL;
	}
...
static int synaptics_btn_rmi4_gpio_setup(int gpio, bool config, int dir, int state)
{
	int retval = 0;
...
static void synaptics_btn_rmi4_set_params(struct synaptics_btn_rmi4_data *rmi4_data)
{
	unsigned char ii;
	struct synaptics_btn_rmi4_f1a_handle *f1a;
	struct synaptics_btn_rmi4_fn *fhandler;
...
static int synaptics_btn_rmi4_set_input_dev(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	const struct synaptics_btn_board_data *bdata =
				rmi4_data->hw_if->board_data;
	...
	retval = synaptics_btn_rmi4_query_device(rmi4_data);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
	...
	rmi4_data->input_dev->id.product = SYNAPTICS_BTN_DRIVER_PRODUCT;
	rmi4_data->input_dev->id.version = SYNAPTICS_BTN_DRIVER_VERSION;
	...
	synaptics_btn_rmi4_set_params(rmi4_data);
	...
	rmi4_data->stylus_dev->id.product = SYNAPTICS_BTN_DRIVER_PRODUCT;
	rmi4_data->stylus_dev->id.version = SYNAPTICS_BTN_DRIVER_VERSION;
...
err_register_input:
err_query_device:
	synaptics_btn_rmi4_empty_fn_list(rmi4_data);
...
static int synaptics_btn_rmi4_set_gpio(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	const struct synaptics_btn_board_data *bdata =
			rmi4_data->hw_if->board_data;

	retval = synaptics_btn_rmi4_gpio_setup(
			bdata->irq_gpio,
			true, 0, 0);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
...
err_gpio_reset:
	if (bdata->power_gpio >= 0)
		synaptics_btn_rmi4_gpio_setup(bdata->power_gpio, false, 0, 0);

err_gpio_power:
	synaptics_btn_rmi4_gpio_setup(bdata->irq_gpio, false, 0, 0);
...
#ifdef NUBIA_TOUCH_SYNAPTICS
static int synaptics_btn_rmi4_get_reg(struct synaptics_btn_rmi4_data *rmi4_data,
		bool get)
{
	int retval;
	const struct synaptics_btn_board_data *bdata =
	...
	if ((bdata->pwr_reg_name != NULL) && (*bdata->pwr_reg_name != 0)) {
		...
		if (regulator_count_voltages(rmi4_data->pwr_reg) > 0) {
			retval = regulator_set_voltage(rmi4_data->pwr_reg,
					bdata->avdd_config->min_voltage,
					bdata->avdd_config->max_voltage);
			if (retval) {
				dev_err(rmi4_data->pdev->dev.parent,
						"Regulator %s set voltage failed rc=%d\n",
						bdata->pwr_reg_name, retval);
				goto regulator_put;
			}
		}
	}
	...
	if ((bdata->bus_reg_name != NULL) && (*bdata->bus_reg_name != 0)) {
		...
		if (regulator_count_voltages(rmi4_data->bus_reg) > 0) {
			retval = regulator_set_voltage(rmi4_data->bus_reg,
					bdata->vdd_config->min_voltage,
					bdata->vdd_config->max_voltage);
			if (retval) {
				dev_err(rmi4_data->pdev->dev.parent,
						"Regulator %s set voltage failed rc=%d\n",
						bdata->bus_reg_name, retval);
				goto regulator_put;
			}
		}
	}
...
#ifdef NUBIA_TOUCH_SYNAPTICS
static int synaptics_btn_rmi4_enable_reset_gpio(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval = 0;
	const struct synaptics_btn_board_data *bdata =
	...
	if (enable) {
		if (bdata->reset_gpio >= 0 && !rmi4_data->avdd_always_on
				&& !rmi4_data->vdd_always_on) {
			retval = synaptics_btn_rmi4_gpio_setup(
					bdata->reset_gpio,
					true, 1, 1);
			if (retval < 0) {
				dev_err(rmi4_data->pdev->dev.parent,
						"%s: failed to set reset_gpio high !\n",
						__func__);
			}
		}
	} else {
		if (bdata->reset_gpio >= 0 && !rmi4_data->avdd_always_on
			...
			if (retval < 0) {
				dev_err(rmi4_data->pdev->dev.parent,
						"%s: failed to set reset_gpio low !\n",
						__func__);
			}
		}
	}
...
static int synaptics_btn_rmi4_enable_reg_gpio(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval = 0;
	const struct synaptics_btn_board_data *bdata =
	...
	if (enable) {
		if (bdata->power_on_avdd_first) {
			if (bdata->power_gpio_avdd >= 0 && !rmi4_data->avdd_always_on) {
				retval = synaptics_btn_rmi4_gpio_setup(
						bdata->power_gpio_avdd,
						true, 1, bdata->gpio_avdd_config->power_on_state);
				if (retval < 0) {
					dev_err(rmi4_data->pdev->dev.parent,
							"%s: failed to set power_gpio_avdd high !\n",
							__func__);
				}
				usleep(bdata->avdd_seq->post_on_sleep * 1000);
			}

			if (bdata->power_gpio_vdd >= 0 && !rmi4_data->vdd_always_on) {
				retval = synaptics_btn_rmi4_gpio_setup(
						bdata->power_gpio_vdd,
						true, 1, bdata->gpio_vdd_config->power_on_state);
				if (retval < 0) {
					dev_err(rmi4_data->pdev->dev.parent,
							"%s: failed to set power_gpio_vdd high !\n",
							__func__);
				}
				usleep(bdata->vdd_seq->post_on_sleep * 1000);
			}
		} else {
			if (bdata->power_gpio_vdd >= 0 && !rmi4_data->vdd_always_on) {
				retval = synaptics_btn_rmi4_gpio_setup(
		...
		if (bdata->power_off_avdd_first) {
			if (bdata->power_gpio_avdd >= 0 && !rmi4_data->avdd_always_on) {
				retval = synaptics_btn_rmi4_gpio_setup(
						bdata->power_gpio_avdd,
						false, 0, !bdata->gpio_avdd_config->power_on_state);
				if (retval < 0) {
					dev_err(rmi4_data->pdev->dev.parent,
							"%s: failed to set power_gpio_avdd low !\n",
							__func__);
				}
				usleep(bdata->avdd_seq->post_off_sleep * 1000);
			}

			if (bdata->power_gpio_vdd >= 0 && !rmi4_data->vdd_always_on) {
				retval = synaptics_btn_rmi4_gpio_setup(
						bdata->power_gpio_vdd,
						false, 0, !bdata->gpio_vdd_config->power_on_state);
				if (retval < 0) {
					dev_err(rmi4_data->pdev->dev.parent,
							"%s: failed to set power_gpio_vdd low !\n",
							__func__);
				}
				usleep(bdata->vdd_seq->post_off_sleep * 1000);
			}
		} else {
			if (bdata->power_gpio_vdd >= 0 && !rmi4_data->vdd_always_on) {
				retval = synaptics_btn_rmi4_gpio_setup(
...
static int synaptics_btn_rmi4_enable_reg(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval = 0;
	bool need_sleep;
	...
	if (bdata->power_on_gpio_first) {
		retval = synaptics_btn_rmi4_enable_reg_gpio(rmi4_data, true);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
					"Enable reg gpio failed rc=%d\n", retval);
			goto exit;
		}
	}

	if (bdata->power_on_avdd_first) {
		if (rmi4_data->pwr_reg && !rmi4_data->avdd_always_on) {
			need_sleep = !regulator_is_enabled(rmi4_data->pwr_reg);
			retval = regulator_set_optimum_mode(rmi4_data->pwr_reg,
					bdata->avdd_config->enable_load);
			if (retval < 0) {
				dev_err(rmi4_data->pdev->dev.parent,
						"Regulator %s set_opt failed rc=%d\n",
						bdata->pwr_reg_name, retval);
				goto exit;
			}
		...
		if (rmi4_data->bus_reg && !rmi4_data->vdd_always_on) {
			need_sleep = !regulator_is_enabled(rmi4_data->bus_reg);
			retval = regulator_set_optimum_mode(rmi4_data->bus_reg,
					bdata->vdd_config->enable_load);
			if (retval < 0) {
				dev_err(rmi4_data->pdev->dev.parent,
						"Regulator %s set_opt failed rc=%d\n",
						bdata->bus_reg_name, retval);
	...
	if (bdata->avdd_always_on) {
		rmi4_data->avdd_always_on = true;
	}

	if (bdata->vdd_always_on) {
		rmi4_data->vdd_always_on = true;
	}

	return 0;

disable_reg:
	if (bdata->power_off_gpio_first) {
		retval = synaptics_btn_rmi4_enable_reg_gpio(rmi4_data, false);
		if (retval < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
				"Disable reg gpio failed rc=%d\n", retval);
			goto exit;
		}
	}
	...
	if (bdata->power_off_avdd_first) {
		if (rmi4_data->pwr_reg && !rmi4_data->avdd_always_on) {
			regulator_set_optimum_mode(rmi4_data->pwr_reg,
					bdata->avdd_config->disable_load);
			regulator_disable(rmi4_data->pwr_reg);
		}
		if (rmi4_data->bus_reg && !rmi4_data->vdd_always_on) {
			regulator_set_optimum_mode(rmi4_data->bus_reg,
					bdata->vdd_config->disable_load);
...
static int synaptics_btn_rmi4_sw_reset(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
...
static int synaptics_btn_rmi4_do_rebuild(struct synaptics_btn_rmi4_data *rmi4_data)
{
	struct synaptics_btn_rmi4_input_settings *settings;
...
static void synaptics_btn_rmi4_rebuild_work(struct work_struct *work)
{
	int retval;
	...
	struct synaptics_btn_rmi4_data *rmi4_data =
			container_of(delayed_work, struct synaptics_btn_rmi4_data,
			rb_work);

#ifdef NUBIA_TOUCH_SYNAPTICS
	synaptics_btn_rmi4_irq_enable(rmi4_data, false, false);
	...
	retval = synaptics_btn_rmi4_set_input_dev(rmi4_data);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
...
exit:
	...
	synaptics_btn_rmi4_irq_enable(rmi4_data, true, false);
#else
	synaptics_btn_rmi4_irq_enable(rmi4_data, true, false);
...
static int synaptics_btn_rmi4_reinit_device(struct synaptics_btn_rmi4_data *rmi4_data)
{
	...
	if (!list_empty(&rmi->support_fn_list)) {
		list_for_each_entry(fhandler, &rmi->support_fn_list, link) {
			if (fhandler->fn_number == SYNAPTICS_RMI4_F12) {
				synaptics_btn_rmi4_f12_set_enables(rmi4_data, 0);
				break;
			}
		}
	}
		...
		bool rebuild)
{
	...
	retval = synaptics_btn_rmi4_sw_reset(rmi4_data);
	if (retval < 0) {
		dev_err(rmi4_data->pdev->dev.parent,
...
exit:
	...
	if (rebuild && synaptics_btn_rmi4_do_rebuild(rmi4_data)) {
...
static void synaptics_btn_rmi4_reset_work(struct work_struct *work)
{
	int retval;
	unsigned int timeout;
	struct synaptics_btn_rmi4_data *rmi4_data =
			container_of(work, struct synaptics_btn_rmi4_data,
			reset_work);
...
static void synaptics_btn_rmi4_sleep_enable(struct synaptics_btn_rmi4_data *rmi4_data,
		bool enable)
{
	int retval;
	unsigned char device_ctrl;
...
#ifdef NUBIA_TOUCH_SYNAPTICS
static void synaptics_btn_rmi4_charge_work(struct work_struct *work)
{
	int retval;
	unsigned char device_ctrl;
...
static void synaptics_btn_rmi4_reset_work_func(struct work_struct *work)
{
	struct synaptics_btn_rmi4_data *rmi4_data =
		container_of(work, struct synaptics_btn_rmi4_data,
			reset_work);

	synaptics_btn_rmi4_resume(&rmi4_data->pdev->dev);
	pr_debug("synaptics btn reset work queue finished !\n");

	return;
}
#endif

static void synaptics_btn_rmi4_exp_fn_work(struct work_struct *work)
{
	struct synaptics_btn_rmi4_exp_fhandler *exp_fhandler;
	struct synaptics_btn_rmi4_exp_fhandler *exp_fhandler_temp;
	struct synaptics_btn_rmi4_data *rmi4_data = exp_data.rmi4_data;
...
void synaptics_btn_rmi4_new_function(struct synaptics_btn_rmi4_exp_fn *exp_fn,
		bool insert)
{
	struct synaptics_btn_rmi4_exp_fhandler *exp_fhandler;
...
EXPORT_SYMBOL(synaptics_btn_rmi4_new_function);

static int synaptics_btn_rmi4_probe(struct platform_device *pdev)
{
	int retval;
	unsigned char attr_count;
	struct synaptics_btn_rmi4_data *rmi4_data;
	const struct synaptics_btn_hw_interface *hw_if;
	const struct synaptics_btn_board_data *bdata;
	...
	rmi4_data->avdd_always_on = false;
	rmi4_data->vdd_always_on = false;
	rmi4_data->enable_wakeup_gesture = false;
	rmi4_data->boot_resume_enabled = true;
#endif

	rmi4_data->reset_device = synaptics_btn_rmi4_reset_device;
	rmi4_data->irq_enable = synaptics_btn_rmi4_irq_enable;
	rmi4_data->sleep_enable = synaptics_btn_rmi4_sleep_enable;
	rmi4_data->report_touch = synaptics_btn_rmi4_report_touch;
	...
	pr_debug("%s: synaptics pinctrl inited, set state to active successfully.\n", __func__);
#endif

	retval = synaptics_btn_rmi4_get_reg(rmi4_data, true);
	if (retval < 0) {
		dev_err(&pdev->dev,
	...
	retval = synaptics_btn_rmi4_enable_reg(rmi4_data, true);
	if (retval < 0) {
		dev_err(&pdev->dev,
	...
	retval = synaptics_btn_rmi4_set_gpio(rmi4_data);
	if (retval < 0) {
		dev_err(&pdev->dev,
...
#ifdef CONFIG_FB
	rmi4_data->fb_notifier.notifier_call = synaptics_btn_rmi4_fb_notifier_cb;
...
#ifdef NUBIA_TOUCH_SYNAPTICS
	if (bdata->open_charge_bit) {
		rmi4_data->power_notifier.notifier_call = synaptics_btn_rmi4_power_notifier_cb;
	...
	rmi4_data->early_suspend.suspend = synaptics_btn_rmi4_early_suspend;
	rmi4_data->early_suspend.resume = synaptics_btn_rmi4_late_resume;
	...
	retval = synaptics_btn_rmi4_irq_enable(rmi4_data, true, false);
	if (retval < 0) {
		dev_err(&pdev->dev,
	...
	INIT_DELAYED_WORK(&rmi4_data->rb_work, synaptics_btn_rmi4_rebuild_work);

	exp_data.workqueue = create_singlethread_workqueue("dsx_exp_workqueue");
	INIT_DELAYED_WORK(&exp_data.work, synaptics_btn_rmi4_exp_fn_work);
	...
	INIT_WORK(&rmi4_data->reset_work, synaptics_btn_rmi4_reset_work);
	queue_work(rmi4_data->reset_workqueue, &rmi4_data->reset_work);
#elif defined(NUBIA_TOUCH_SYNAPTICS)
	rmi4_data->reset_workqueue =
			create_singlethread_workqueue("dsx_reset_workqueue");
	INIT_WORK(&rmi4_data->reset_work, synaptics_btn_rmi4_reset_work_func);
#endif

#ifdef NUBIA_TOUCH_SYNAPTICS
	rmi4_data->charge_workqueue =
			create_singlethread_workqueue("dsx_charge_workqueue");
	INIT_DELAYED_WORK(&rmi4_data->charge_work, synaptics_btn_rmi4_charge_work);
#endif
...
err_set_input_dev:
	...
	if (bdata->reset_gpio >= 0)
		synaptics_btn_rmi4_gpio_setup(bdata->reset_gpio, false, 0, 0);
...
err_ui_hw_init:
err_set_gpio:
	synaptics_btn_rmi4_enable_reg(rmi4_data, false);

err_enable_reg:
	synaptics_btn_rmi4_get_reg(rmi4_data, false);
...
static int synaptics_btn_rmi4_remove(struct platform_device *pdev)
{
	unsigned char attr_count;
	struct synaptics_btn_rmi4_data *rmi4_data = platform_get_drvdata(pdev);
	const struct synaptics_btn_board_data *bdata =
			rmi4_data->hw_if->board_data;
		...
		unsigned long event, void *data)
{
	...
	struct synaptics_btn_rmi4_data *rmi4_data =
			container_of(self, struct synaptics_btn_rmi4_data,
			fb_notifier);
#ifdef NUBIA_TOUCH_SYNAPTICS
	const struct synaptics_btn_board_data *bdata =
			rmi4_data->hw_if->board_data;
	...
	if (event == FB_EARLY_EVENT_BLANK) {
		if (bdata->touch_suspend_first) {
			if (*transition == FB_BLANK_POWERDOWN) {
				synaptics_btn_rmi4_suspend(&rmi4_data->pdev->dev);
				rmi4_data->fb_ready = false;
			}
		}
		if (bdata->touch_resume_first) {
		...
		if (!bdata->touch_resume_first) {
			if (*transition == FB_BLANK_UNBLANK) {
				if (rmi4_data->hw_if->board_data->fb_ready_reset) {
					queue_work(rmi4_data->reset_workqueue, &rmi4_data->reset_work);
				} else {
					synaptics_btn_rmi4_resume(&rmi4_data->pdev->dev);
				}
...
static void synaptics_btn_rmi4_early_suspend(struct early_suspend *h)
{
	struct synaptics_btn_rmi4_exp_fhandler *exp_fhandler;
	struct synaptics_btn_rmi4_data *rmi4_data =
			container_of(h, struct synaptics_btn_rmi4_data,
			early_suspend);
	unsigned char device_ctrl;
	...
	if (rmi4_data->enable_wakeup_gesture) {
		if (rmi4_data->no_sleep_setting) {
			synaptics_btn_rmi4_reg_read(rmi4_data,
					rmi4_data->f01_ctrl_base_addr,
					&device_ctrl,
					sizeof(device_ctrl));
			device_ctrl = device_ctrl & ~NO_SLEEP_ON;
			synaptics_btn_rmi4_reg_write(rmi4_data,
					rmi4_data->f01_ctrl_base_addr,
					&device_ctrl,
					sizeof(device_ctrl));
		}
		synaptics_btn_rmi4_wakeup_gesture(rmi4_data, true);
...
#endif
	synaptics_btn_rmi4_irq_enable(rmi4_data, false, false);
	synaptics_btn_rmi4_sleep_enable(rmi4_data, true);
	synaptics_btn_rmi4_free_fingers(rmi4_data);
...
static void synaptics_btn_rmi4_late_resume(struct early_suspend *h)
{
	...
	if (rmi4_data->suspend) {
		synaptics_btn_rmi4_sleep_enable(rmi4_data, false);
		synaptics_btn_rmi4_irq_enable(rmi4_data, true, false);
	}
...
static int synaptics_btn_rmi4_suspend(struct device *dev)
{
	...
	if (rmi4_data->hw_if->board_data->fb_ready_reset)
		flush_work(&rmi4_data->reset_work);
	...
	if (rmi4_data->enable_wakeup_gesture) {
		...
		enable_irq_wake(rmi4_data->irq);
#ifdef NUBIA_TOUCH_SYNAPTICS
		pr_info("synaptics wakeup gesture suspend !\n");
#endif
		goto exit;
	}
...
static int synaptics_btn_rmi4_resume(struct device *dev)
{
...
#ifdef NUBIA_TOUCH_SYNAPTICS
	if (rmi4_data->boot_resume_enabled) {
		ret = synaptics_btn_rmi4_reset_device(rmi4_data, false);
		if (ret < 0) {
			dev_err(rmi4_data->pdev->dev.parent,
					"%s: Failed to issue reset command\n",
					__func__);
		}
		rmi4_data->boot_resume_enabled = false;
	...
	if (rmi4_data->enable_wakeup_gesture) {
		disable_irq_wake(rmi4_data->irq);
#ifdef NUBIA_TOUCH_SYNAPTICS
		pr_info("synaptics wakeup gesture resume !\n");
#endif
		goto exit;
	}
...
#ifdef NUBIA_TOUCH_SYNAPTICS
	synaptics_btn_rmi4_enable_reset_gpio(rmi4_data, true);
	synaptics_btn_rmi4_enable_reg(rmi4_data, true);
#endif
	synaptics_btn_rmi4_sleep_enable(rmi4_data, false);
	synaptics_btn_rmi4_irq_enable(rmi4_data, true, false);

#ifdef NUBIA_TOUCH_SYNAPTICS
	pr_info("%s: synaptics resume !\n", __func__);
#endif
...
exit:
	...
	if (rmi4_data->hw_if->board_data->open_charge_bit) {
		if (rmi4_data->is_charging) {
			queue_delayed_work(rmi4_data->charge_workqueue,
					&rmi4_data->charge_work,
					msecs_to_jiffies(1));
...
#ifdef CONFIG_PM
static const struct dev_pm_ops synaptics_btn_rmi4_dev_pm_ops = {
#ifndef CONFIG_FB
	.suspend = synaptics_btn_rmi4_suspend,
	.resume = synaptics_btn_rmi4_resume,
#endif
};
#endif

static struct platform_driver synaptics_btn_rmi4_driver = {
	.driver = {
		.name = PLATFORM_DRIVER_NAME,
		.owner = THIS_MODULE,
#ifdef CONFIG_PM
		.pm = &synaptics_btn_rmi4_dev_pm_ops,
#endif
	},
	.probe = synaptics_btn_rmi4_probe,
	.remove = synaptics_btn_rmi4_remove,
};

static int __init synaptics_btn_rmi4_init(void)
{
	int retval;

	retval = synaptics_btn_rmi4_bus_init();
	if (retval)
		return retval;

	return platform_driver_register(&synaptics_btn_rmi4_driver);
}

static void __exit synaptics_btn_rmi4_exit(void)
{
	platform_driver_unregister(&synaptics_btn_rmi4_driver);

	synaptics_btn_rmi4_bus_exit();

	return;
}

module_init(synaptics_btn_rmi4_init);
module_exit(synaptics_btn_rmi4_exit);

MODULE_AUTHOR("Synaptics, Inc.");
MODULE_DESCRIPTION("Synaptics Button DSX Touch Driver");
