...
#define GESTURE_PHYS_NAME "synaptics_btn/gesture"
...
struct synaptics_btn_rmi4_f12_query_0 {
	union {
		struct {
			struct {
...
struct synaptics_btn_rmi4_f12_control_41 {
	union {
		struct {
...
struct synaptics_btn_rmi4_udg_handle {
	atomic_t attn_event;
...
static struct synaptics_btn_rmi4_udg_handle *udg;
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	bool enable;
	unsigned int input;
	struct synaptics_btn_rmi4_f12_control_41 control_41;
	struct synaptics_btn_rmi4_data *rmi4_data = udg->rmi4_data;
...
static int udg_ctrl_subpacket(unsigned char ctrlreg,
		...
		struct synaptics_btn_rmi4_f12_query_5 *query_5)
{
	int retval;
	unsigned char cnt;
...
static int udg_reg_init(void)
{
	...
	struct synaptics_btn_rmi4_f12_query_0 query_0;
	struct synaptics_btn_rmi4_f12_query_5 query_5;
	struct synaptics_btn_rmi4_f12_query_8 query_8;
	struct synaptics_btn_rmi4_data *rmi4_data = udg->rmi4_data;
...
static void synaptics_btn_rmi4_udg_attn(struct synaptics_btn_rmi4_data *rmi4_data,
		unsigned char intr_mask)
{
	if (!udg)
		return;
...
static int synaptics_btn_rmi4_udg_init(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	unsigned char ii;
	unsigned char size;
	...
	udg->udg_dev->id.product = SYNAPTICS_BTN_DRIVER_PRODUCT;
	udg->udg_dev->id.version = SYNAPTICS_BTN_DRIVER_VERSION;
...
static void synaptics_btn_rmi4_udg_remove(struct synaptics_btn_rmi4_data *rmi4_data)
{
	unsigned char count;
...
static void synaptics_btn_rmi4_udg_reset(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!udg) {
		synaptics_btn_rmi4_udg_init(rmi4_data);
		return;
	}
...
static void synaptics_btn_rmi4_udg_reinit(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void synaptics_btn_rmi4_udg_e_suspend(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void synaptics_btn_rmi4_udg_suspend(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void synaptics_btn_rmi4_udg_resume(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static void synaptics_btn_rmi4_udg_l_resume(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!udg)
		return;
...
static struct synaptics_btn_rmi4_exp_fn gesture_module = {
	.fn_type = RMI_GESTURE,
	.init = synaptics_btn_rmi4_udg_init,
	.remove = synaptics_btn_rmi4_udg_remove,
	.reset = synaptics_btn_rmi4_udg_reset,
	.reinit = synaptics_btn_rmi4_udg_reinit,
	.early_suspend = synaptics_btn_rmi4_udg_e_suspend,
	.suspend = synaptics_btn_rmi4_udg_suspend,
	.resume = synaptics_btn_rmi4_udg_resume,
	.late_resume = synaptics_btn_rmi4_udg_l_resume,
	.attn = synaptics_btn_rmi4_udg_attn,
};

static int __init rmi4_gesture_module_init(void)
{
	synaptics_btn_rmi4_new_function(&gesture_module, true);
...
{
	synaptics_btn_rmi4_new_function(&gesture_module, false);
...
MODULE_DESCRIPTION("Synaptics Button DSX User Defined Gesture Module");
