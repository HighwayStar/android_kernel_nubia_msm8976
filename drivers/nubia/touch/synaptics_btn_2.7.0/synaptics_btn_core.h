...
#ifndef _SYNAPTICS_BTN_RMI4_H_
#define _SYNAPTICS_BTN_RMI4_H_

#define SYNAPTICS_DS4 (1 << 0)
#define SYNAPTICS_DS5 (1 << 1)
#define SYNAPTICS_BTN_DRIVER_PRODUCT (SYNAPTICS_DS4 | SYNAPTICS_DS5)
#define SYNAPTICS_BTN_DRIVER_VERSION 0x2070
...
/*
 * struct synaptics_btn_rmi4_fn_desc - function descriptor fields in PDT entry
 ...
 */
struct synaptics_btn_rmi4_fn_desc {
	union {
		struct {
...
/*
 * synaptics_btn_rmi4_fn_full_addr - full 16-bit base addresses
 ...
 */
struct synaptics_btn_rmi4_fn_full_addr {
...
/*
 * struct synaptics_btn_rmi4_f11_extra_data - extra data of F$11
 * @data38_offset: offset to F11_2D_DATA38 register
 */
struct synaptics_btn_rmi4_f11_extra_data {
	unsigned char data38_offset;
};

/*
 * struct synaptics_btn_rmi4_f12_extra_data - extra data of F$12
 ...
 */
struct synaptics_btn_rmi4_f12_extra_data {
...
/*
 * struct synaptics_btn_rmi4_fn - RMI function handler
 * @fn_number: function number
 ...
 */
struct synaptics_btn_rmi4_fn {
	unsigned char fn_number;
	unsigned char num_of_data_sources;
	unsigned char num_of_data_points;
	unsigned char intr_reg_num;
	unsigned char intr_mask;
	struct synaptics_btn_rmi4_fn_full_addr full_addr;
...
/*
 * struct synaptics_btn_rmi4_input_settings - current input settings
 ...
 */
struct synaptics_btn_rmi4_input_settings {
...
/*
 * struct synaptics_btn_rmi4_device_info - device information
 ...
 */
struct synaptics_btn_rmi4_device_info {
...
/*
 * struct synaptics_btn_rmi4_data - RMI4 device instance data
 ...
 */
struct synaptics_btn_rmi4_data {
	struct platform_device *pdev;
	struct input_dev *input_dev;
	struct input_dev *stylus_dev;
	const struct synaptics_btn_hw_interface *hw_if;
	struct synaptics_btn_rmi4_device_info rmi4_mod_info;
	struct synaptics_btn_rmi4_input_settings input_settings;
	...
	bool avdd_always_on;
	bool vdd_always_on;
	struct synaptics_btn_pinctrl pinctrl_info;
#endif
	int (*reset_device)(struct synaptics_btn_rmi4_data *rmi4_data,
			bool rebuild);
	int (*irq_enable)(struct synaptics_btn_rmi4_data *rmi4_data, bool enable,
			bool attn_only);
	void (*sleep_enable)(struct synaptics_btn_rmi4_data *rmi4_data,
			bool enable);
	void (*report_touch)(struct synaptics_btn_rmi4_data *rmi4_data,
			struct synaptics_btn_rmi4_fn *fhandler);
};

struct synaptics_btn_bus_access {
	unsigned char type;
	int (*read)(struct synaptics_btn_rmi4_data *rmi4_data, unsigned short addr,
		unsigned char *data, unsigned int length);
	int (*write)(struct synaptics_btn_rmi4_data *rmi4_data, unsigned short addr,
		unsigned char *data, unsigned int length);
};

struct synaptics_btn_hw_interface {
	struct synaptics_btn_board_data *board_data;
	const struct synaptics_btn_bus_access *bus_access;
	int (*bl_hw_init)(struct synaptics_btn_rmi4_data *rmi4_data);
	int (*ui_hw_init)(struct synaptics_btn_rmi4_data *rmi4_data);
};

struct synaptics_btn_rmi4_exp_fn {
	enum exp_fn fn_type;
	int (*init)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*remove)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*reset)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*reinit)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*early_suspend)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*suspend)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*resume)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*late_resume)(struct synaptics_btn_rmi4_data *rmi4_data);
	void (*attn)(struct synaptics_btn_rmi4_data *rmi4_data,
			unsigned char intr_mask);
};
...
void synaptics_btn_rmi4_new_function(struct synaptics_btn_rmi4_exp_fn *exp_fn_module,
		bool insert);

int synaptics_fw_updater(const unsigned char *fw_data);

static inline int synaptics_btn_rmi4_reg_read(
...
static inline int synaptics_btn_rmi4_reg_write(
		struct synaptics_btn_rmi4_data *rmi4_data,
		unsigned short addr,
		unsigned char *data,
		unsigned int len)
...
static inline ssize_t synaptics_btn_rmi4_show_error(struct device *dev,
...
static inline ssize_t synaptics_btn_rmi4_store_error(struct device *dev,
