...
#define PROX_PHYS_NAME "synaptics_btn/proximity"

#define HOVER_Z_MAX (255)

#define HOVERING_FINGER_EN (1 << 4)

static ssize_t synaptics_btn_rmi4_hover_finger_en_show(struct device *dev,
		struct device_attribute *attr, char *buf);

static ssize_t synaptics_btn_rmi4_hover_finger_en_store(struct device *dev,
		struct device_attribute *attr, const char *buf, size_t count);

static struct device_attribute attrs[] = {
	__ATTR(hover_finger_en, (S_IRUGO | S_IWUGO),
			synaptics_btn_rmi4_hover_finger_en_show,
			synaptics_btn_rmi4_hover_finger_en_store),
};
...
struct synaptics_btn_rmi4_prox_handle {
...
static struct synaptics_btn_rmi4_prox_handle *prox;
...
static void prox_hover_finger_report(void)
{
	...
	struct synaptics_btn_rmi4_data *rmi4_data = prox->rmi4_data;
...
int synaptics_btn_rmi4_prox_hover_finger_en(bool enable)
{
	int retval;
...
EXPORT_SYMBOL(synaptics_btn_rmi4_prox_hover_finger_en);

static void synaptics_btn_rmi4_prox_attn(struct synaptics_btn_rmi4_data *rmi4_data,
		unsigned char intr_mask)
{
	if (!prox)
		return;
...
static int synaptics_btn_rmi4_prox_init(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	...
	prox->prox_dev->id.product = SYNAPTICS_BTN_DRIVER_PRODUCT;
	prox->prox_dev->id.version = SYNAPTICS_BTN_DRIVER_VERSION;
...
static void synaptics_btn_rmi4_prox_remove(struct synaptics_btn_rmi4_data *rmi4_data)
{
	unsigned char attr_count;
...
static void synaptics_btn_rmi4_prox_reset(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!prox) {
		synaptics_btn_rmi4_prox_init(rmi4_data);
		return;
	}
...
static void synaptics_btn_rmi4_prox_reinit(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!prox)
		return;
...
static void synaptics_btn_rmi4_prox_e_suspend(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!prox)
		return;
...
static void synaptics_btn_rmi4_prox_suspend(struct synaptics_btn_rmi4_data *rmi4_data)
{
	if (!prox)
		return;
...
static struct synaptics_btn_rmi4_exp_fn proximity_module = {
	.fn_type = RMI_PROXIMITY,
	.init = synaptics_btn_rmi4_prox_init,
	.remove = synaptics_btn_rmi4_prox_remove,
	.reset = synaptics_btn_rmi4_prox_reset,
	.reinit = synaptics_btn_rmi4_prox_reinit,
	.early_suspend = synaptics_btn_rmi4_prox_e_suspend,
	.suspend = synaptics_btn_rmi4_prox_suspend,
	.resume = NULL,
	.late_resume = NULL,
	.attn = synaptics_btn_rmi4_prox_attn,
};

static int __init rmi4_proximity_module_init(void)
{
	synaptics_btn_rmi4_new_function(&proximity_module, true);
...
{
	synaptics_btn_rmi4_new_function(&proximity_module, false);
...
MODULE_DESCRIPTION("Synaptics Button DSX Proximity Module");
