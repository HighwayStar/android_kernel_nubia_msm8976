...
static int parse_report_descriptor(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	unsigned int ii = 0;
	unsigned char *buf;
...
static int switch_to_rmi(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	struct i2c_client *i2c = to_i2c_client(rmi4_data->pdev->dev.parent);
...
static int check_report_mode(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
...
static int hid_i2c_init(struct synaptics_btn_rmi4_data *rmi4_data)
{
	int retval;
	struct i2c_client *i2c = to_i2c_client(rmi4_data->pdev->dev.parent);
