		...
		struct device_attribute *attr, char *buf)
{
	...
	int rx_num = f54->rx_assigned;
	short *report_data_16;
	short low_cap = 800; //min value, this will be reconfiged later
	short up_cap = 3800; //max value, this will be reconfiged later
...
#define PBUF_LEN 1024
        ...
        //key leveel
        short key_1[2] = {1500, 3500};
        short key_2[2] = {3000, 5000};
        short key_3[2] = {1500, 3500};
